...
if ( ! function_exists( 'tuts_scripts' ) ) {
	function tuts_scripts() {
		/* Register scripts. */
		wp_register_script( 'modernizer-js', JS . '/vendor/modernizr-2.6.2.min.js', false, false, false );
		wp_register_script( 'bootstrap-js', THEMEROOT . '/bower-components/bootstrap/dist/js/bootstrap.min.js', array( 'jquery' ), false, true );
		wp_register_script( 'isotope-js', THEMEROOT . '/bower-components/isotope/dist/isotope.pkgd.min.js', false, false, true );
		...
		wp_enqueue_style( 'bootstrap-css', THEMEROOT . '/bower-components/bootstrap/dist/css/bootstrap.min.css' );
